...
const FilterSubHead: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white border-b-1 border-gray-200 shadow-sm p-4 flex justify-between items-center">
        <div className="flex gap-5 items-center ">
          <div className='flex '>
          <p className="text-[#130562] text-medium flex  space-x-2 ">
             Filter
          </p>
          <div  className=''>
        ...
        <div className='flex justify-between'>
                      ...
                      <div className='border-[red] w-3 h-full border-r-1'>
