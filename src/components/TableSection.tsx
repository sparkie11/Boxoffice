        ...
        <tr key={item.id}>
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              ...
              onChange={(e) => handleCellChange(item.id, 'ticketType', e.target.value as 'E-ticket' | 'Physical' | 'Local Delivery' | 'Flash Seats' | 'Mobile Transfer')}
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              ...
              onChange={(e) => handleCellChange(item.id, 'splitType', e.target.value as 'None' | 'Even' | 'Odd' | 'Pair' | 'Single')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              value={item.category}
              onChange={(e) => handleCellChange(item.id, 'category', e.target.value as 'Away Fans Section' | 'Home Fans Section' | 'Lower Tier' | 'Upper Tier' | 'Club Level')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              ...
              onChange={(e) => handleCellChange(item.id, 'sectionBlock', e.target.value as 'Longside Lower Tier' | 'Shortside Lower Tier' | 'Longside Upper Tier' | 'Shortside Upper Tier' | 'Block 1' | 'Block 2' | 'Block 3')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              value={item.row}
              onChange={(e) => handleCellChange(item.id, 'row', e.target.value as '5' | 'A' | 'B' | 'C' | '1' | '2' | '3')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              ...
              onChange={(e) => handleCellChange(item.id, 'firstSeat', e.target.value as '1' | '2' | '3' | '4' | '5')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
              <option value="1">1</option>
              <option value="2">2</option>
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <input
              ...
              onChange={(e) => handleCellChange(item.id, 'faceValue', parseFloat(e.target.value))}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            />
          </td>
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <input
              ...
              onChange={(e) => handleCellChange(item.id, 'payoutPrice', parseFloat(e.target.value))}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            />
          </td>
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              ...
              onChange={(e) => handleCellChange(item.id, 'seatingArrangement', e.target.value as 'Not Seated Together' | 'Seated Together' | 'Aisle Seats' | 'Center Seats')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <input
              ...
              onChange={(e) => handleCellChange(item.id, 'dateToShip', e.target.value)}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            />
          </td>
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <input
              type="checkbox"
              checked={item.ticketsInHand}
              onChange={(e) => handleCellChange(item.id, 'ticketsInHand', e.target.checked)}
              className="h-4 w-4 text-blue-600 border-gray-300 rounded"
            />
          </td>
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <input
              ...
              onChange={(e) => handleCellChange(item.id, 'matchEvent', e.target.value)}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            />
          </td>
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              value={item.fanArea}
              onChange={(e) => handleCellChange(item.id, 'fanArea', e.target.value as 'Home' | 'Away' | 'Neutral')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              value={item.benefits}
              onChange={(e) => handleCellChange(item.id, 'benefits', e.target.value as 'None' | 'Free Parking' | 'VIP Access' | 'Food and Beverage Included' | 'Merchandise Discount')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
              <option value="None">None</option>
          ...
          <td className="px-4 py-2 text-sm text-gray-900 border-r border-gray-200">
            <select
              ...
              onChange={(e) => handleCellChange(item.id, 'restrictions', e.target.value as 'None' | 'Age Limit' | 'Bag Policy' | 'No Re-entry' | 'Camera Restrictions')}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            >
              <option value="None">None</option>
