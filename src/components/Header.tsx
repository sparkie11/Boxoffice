...
<button className="border-2 border-custom-dark-blue text-custom-dark-blue font-bold px-4 py-2 rounded-md hover:bg-custom-dark-blue hover:text-white">
  Request Event
</button>
<button className='flex justify-center items-center p-2 rounded-full bg-custom-blue '>
