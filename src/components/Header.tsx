        ...
        <div className="fixed inset-0 z-50 flex justify-end sm:hidden">
          ...
          <div className="relative bg-white w-64 h-full shadow-lg p-4 animate-slide-in-right">
            ...
            <nav className="flex flex-col space-y-2">
              <a href="#" className="p-2 rounded-md text-gray-700 hover:bg-gray-200 flex items-center">
                <FaHome className="mr-2" /> Home
              </a>
              <a href="#" className="p-2 rounded-md text-blue-600 hover:bg-gray-200 flex items-center">
